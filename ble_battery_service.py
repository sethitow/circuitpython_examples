...
# Create a service for our battery level characteristic
...
while True:
    ...
    # Only set the value of the characteristic if a client is connected.
    # Setting the charateristic value without a client connected throws an OSError
    if periph.connected:
